...
public class SameMethylationLevelModel extends ModelSelection {
    ...
    public double paramsPseudoDistributionProbability(boolean usePseudoPrior) {
        ...
        if (!usePseudoPrior) {
            ...
            // tretNonPeakExpPseudo = this.treatmentNonPeakExpressionPseudoSampler.getLogDensity(tretNonPeakExp);
            // ctrlNonPeakExpPseudo = this.treatmentNonPeakExpressionPseudoSampler.getLogDensity(ctrlNonPeakExp);
        }
